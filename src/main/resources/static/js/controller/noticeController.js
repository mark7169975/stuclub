 //控制层 
app.controller('noticeController' ,function($scope,$controller   ,noticeService){	
	...
	$scope.save=function(){				
		...
		if($scope.entity.id!=null){//如果有ID
			serviceObject=noticeService.update( $scope.entity ); //修改  
		}else{
			serviceObject=noticeService.add( $scope.entity  );//增加 
		}				
